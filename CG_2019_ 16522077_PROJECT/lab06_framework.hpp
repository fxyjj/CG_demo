...
//refer to: http://image.baidu.com/search/index?tn=baiduimage&ct=201326592&lm=-1&cl=2&ie=gb18030&word=%C4%BE%D6%CA%CE%C6%C0%ED%CD%BC%C6%AC&fr=ala&ala=1&alatpl=adress&pos=0&hs=2&xthttps=000000
int width, height, channel;
unsigned char *data_1 = stbi_load("waterwood.jpg", &width, &height, &channel, 0);

//refer to: https://sketchfab.com/3d-models/fantasy-sky-background-15c79bb2fc1147128039fe4ff90fd5a0
int width1, height1, channel1;
unsigned char *data_2 = stbi_load("background.jpg", &width1, &height1, &channel1, 0);
